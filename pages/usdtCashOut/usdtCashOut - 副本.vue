<template>
	<view>
		...
		<view class="cashout">
			...
			<view class="Type fwsmall fs-16">最小提币数量为: 35USDT(ERC20)。为保障资金安全，当账户安全策略变更、密码修改、我们会对提币进行人工审核，请耐心等待工作人员电话或邮件联系
			</view>
			<view class="bottom">
	...
	export default {
		...
		methods: {
			...
			clickSubmit() {
				...
				throtte(this.withdrawUSDT,1500)//节流，防止误提交多条数据
			},
			// 发送短信
			sendMessage() {
				if (this.timer !== null) {
